...
##Changelog
##Fixed error in peaks clear (Some fringe cases caused the entire buffer to clear throwing an error)
##Adjusted threshold decay rate to be more "jumpy"
##Adjusted start of message pushes - waits 10 seconds to have data set before beginning push to redis, should reduce #-1s
            ...
            if temp["device"] == 'BH3' and temp["messageType"] == 'EDP':
                ...
                if len(ZephyrID[currentZephyr][0])>10*63: ##When 10 sets of 63 samples are in the buffer, begin calculations
                    ...
                    if len(ZephyrID[currentZephyr][2])>=11: ##Adjust the number of peaks to detect from 11 to 2 for rough PtP calculation - Further refinement of PtP for HRV
                        ...
                        elif numReliable <9  and numReliable>2: # Not enough reliable peaks, increase decay rate to catch more variation
